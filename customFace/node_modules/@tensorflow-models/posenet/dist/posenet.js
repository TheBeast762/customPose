...
}(this, (function (exports,tf,tfc) { 'use strict';
              ...
              return __generator(this, function (_e) {
                  switch (_e.label) {
                      ...
                      case 1:
                          ...
                          return [4, decodeMultiplePoses(scoresBuffer, offsetsBuffer, displacementsFwdBuffer, displacementsBwdBuffer, outputStride, config.maxDetections, config.scoreThreshold, config.nmsRadius)];
                      case 2:
                          poses = _e.sent();
                          return [3, 5];
                      case 3: return [4, decodeSinglePose(heatmapScores, offsets, outputStride)];
                      case 4:
                          pose = _e.sent();
                          poses = [pose];
                          _e.label = 5;
          ...
          return __generator(this, function (_a) {
              switch (_a.label) {
                  case 0:
                      ...
                      url = mobileNetCheckpoint(inputResolution, outputStride, multiplier, quantBytes);
                      return [4, tfc.loadGraphModel(config.modelUrl || url)];
                  case 1:
                      graphModel = _a.sent();
                      mobilenet = new MobileNet(graphModel, inputResolution, outputStride);
      ...
      return __awaiter(this, void 0, void 0, function () {
          ...
          return __generator(this, function (_a) {
              switch (_a.label) {
                  ...
                  case 1:
                      graphModel = _a.sent();
                      resnet = new ResNet(graphModel, inputResolution, outputStride);
